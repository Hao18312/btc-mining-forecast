...
|:--:|:--|:--|:--|:--|:--:|:--:|:--:|
| 1 | **CoinMetrics community network data (Bitcoin)** — daily chain-level indicators such as difficulty, hashrate, fees, and prices. | [https://coinmetrics.io/community-network-data/](https://coinmetrics.io/community-network-data/) | File (CSV) | `time`, `DiffMean`, `HashRate`, `PriceUSD`, `FeeTotUSD`, `RevHashUSD` | CSV | Yes — loaded using `pandas` | ≥3,000 daily points |
| 2 | **Blockchain.com Explorer API** — provides network charts and block-level stats (difficulty, hashrate, fees). | [https://www.blockchain.com/explorer/api](https://www.blockchain.com/explorer/api) | API (REST) | `difficulty`, `hash_rate`, `tx_count`, `fees` | JSON | Yes — fetched via `requests` | ≥1,000 time points |
...
All sources contain at least 300+ records, satisfying project requirements.
